...
def control_panel(request):
    ...
    return render_to_response('../templates/control_panel.pt',
                              {'api': api})
...
def list_admins(request):
    ...
    return render_to_response('../templates/list_admins.pt',
                              {'api': api,
...
def list_projects(request):
    ...
    api = TemplateAPI(request)
    return render_to_response('../templates/list_projects.pt',
                              {'api': api,
                               'projects': projects})
